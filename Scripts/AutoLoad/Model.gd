...
var plants := [
	...
	},
	{
		...
		"likes": {},
		"dislikes": {Plant.MIGHTY_OAK: true, Plant.SQUIRREL_CORN: true},
		"weight": 12,
	},
	{
		"name": "Cony Fierce",
	...
	},
	{
		...
		"likes": {Plant.HIVE_SUCCULENT: true},
		"dislikes": {Plant.WATER: true},
		"weight": 2,
	},
	{
		...
		"likes": {Plant.WATER: true, Plant.FROG_FERN: true, Plant.SQUIRREL_CORN: true, Plant.BIRD_OF_PARADISE: true},
		"dislikes": {Plant.BEARS_PAW: true, Plant.WOLFS_BANE: true},
		"weight": 1,
	},
	{
		"name": "Rabbit's Foot",
	...
	},
	{
		...
		"likes": {Plant.MIGHTY_OAK: true, Plant.SUN_FLOWER: true},
		"dislikes": {Plant.BEARS_PAW: true, Plant.WOLFS_BANE: true, Plant.BIRD_OF_PARADISE: true},
		"weight": 3,
	},
	{
		"name": "Frog Fern",
		"texture": preload("res://Assets/Textures/FrogFern.png"),
		"likes": {Plant.BEE_ORCHID: true, Plant.SPIDER_PLANT: true},
		"dislikes": {Plant.BEARS_PAW: true, Plant.WOLFS_BANE: true, Plant.BIRD_OF_PARADISE: true},
		"weight": 5,
	},
	{
		...
		"likes": {Plant.MIGHTY_OAK: true, Plant.SQUIRREL_CORN: true, Plant.FROG_FERN: true, Plant.SUN_FLOWER: true, Plant.BEE_ORCHID: true},
	...
	},
	{
		...
		"likes": {Plant.HIVE_SUCCULENT: true, Plant.SQUIRREL_CORN: true, Plant.FROG_FERN: true},
	...
	},
	{
		...
		"dislikes": {Plant.MIGHTY_OAK: true, Plant.BEARS_PAW: true},
		"weight": 4,
	},
	{
		"name": "Bee Orchid",
		...
		"dislikes": {Plant.SPIDER_PLANT: true},
		"weight": 2,
	},
	{
		"name": "Hive Succulent",
		"texture": preload("res://Assets/Textures/HiveSucculent.png"),
		"likes": {Plant.SUN_FLOWER: true, Plant.BIRD_OF_PARADISE: true},
		"dislikes": {Plant.BEARS_PAW: true, Plant.SPIDER_PLANT: true},
		"weight": 3,
	},
	{
		"name": "Spider Plant",
